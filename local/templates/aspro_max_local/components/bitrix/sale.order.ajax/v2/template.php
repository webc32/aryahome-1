...
$APPLICATION->AddViewContent('more_text_title', '<div class="basket-back font_xs"><a href="'.CMax::GetFrontParametrValue('BASKET_PAGE_URL').'" class="basket-back__link muted">'.Loc::getMessage('GO_TO_BASKET').'</a></div>');
?>
	<NOSCRIPT>
...
else
{
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order-main" class="row orderform--v2 bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			<!--	MAIN BLOCK	-->
			<div class="col-md-9 bx-soa">
				...
				<!--	BUYER PROPS BLOCK	-->
				<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active bx">
					<div class="bx-soa-section-title-container bx-soa-section-title-container--no-change bx-soa-section-title-container--flex bx-soa-section-title--jc-start ">
						<h2 class="bx-soa-section-title"><?=$arParams['MESS_BUYER_BLOCK_NAME']?></h2>
						<div class="bx-soa-person-type"></div>
					</div>
					<div class="bx-soa-sect ion-content container-fluid"></div>
					<div class="bx-compact-wrapper bx-compact-wrapper--profile profiles-content container-fluid"></div>
				</div>
				...
				<div class="pandd">
					<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
						...
						<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active">
							<div class="bx-soa-section-title-container bx-soa-section-title-container--flex">
						...
						<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
							<div class="bx-soa-section-title-container bx-soa-section-title-container--flex">
								<h2 class="bx-soa-section-title"><?=$arParams['MESS_DELIVERY_BLOCK_NAME']?><span><?=Loc::getMessage('TITLE_SOA_DESTINATION')?></span><span><?=Loc::getMessage('TITLE_SOA_CHANGE_CITY')?></span></h2>
								<div class="change-info btn btn-transparent-border-color"><?=Loc::getMessage('TITLE_SOA_CHANGE_INFO_SECTION')?></div>
							</div>
							<div class="bx-soa-section-location bx-soa-section-title-container"></div>
							<div class="bx-soa-section-content container-fluid"></div>
							<div class="bx-compact-wrapper"></div>
						</div>
						<!--	PICKUP BLOCK	-->
					...
					<? else: ?>
						...
						<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
							<div class="bx-soa-section-title-container bx-soa-section-title-container--flex">
								<h2 class="bx-soa-section-title"><?=$arParams['MESS_DELIVERY_BLOCK_NAME']?><span class="city_destination"><?=Loc::getMessage('TITLE_SOA_DESTINATION')?></span><span class="change_city font_xs colored "><?=Loc::getMessage('TITLE_SOA_CHANGE_CITY')?></span></h2>
								<div class="change-info btn btn-transparent-border-color"><?=Loc::getMessage('TITLE_SOA_CHANGE_INFO_SECTION')?></div>
							</div>
							<div class="bx-soa-section-location bx-soa-section-title-container"></div>
							<div class="bx-soa-section-content container-fluid"></div>
				...
				<!--	ORDER SAVE BLOCK	-->	
				<div id="bx-soa-orderSave2" class="hidden">
					<div class="checkbox">
						<?
				...
				<div id="bx-soa-total-mobile" style="display:none !important;" class="hidden"></div>
			...
			<div id="bx-soa-total" class="col-sm-3 bx-soa-sidebar">
				...
				<div class="bx-soa-total-wrapper">
	...
	<script>
		...
		BX.Sale.OrderAjaxComponent.init({
			...
			orderBlockId: 'bx-soa-order-main',
