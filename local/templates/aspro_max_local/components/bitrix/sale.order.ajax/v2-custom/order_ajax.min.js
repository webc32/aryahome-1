BX.namespace("BX.Sale.OrderAjaxComponent"), function () {
    ...
    BX.Sale && BX.Sale.Input && BX.Sale.Input.Utils && (BX.Sale.Input.Utils.asMultiple = function (value) {
        ...
        initializePrimaryFields: function () {
                ...
                onsuccess: BX.delegate((function (result) {
                    switch (result.redirect && result.redirect.length && (document.location.href = result.redirect), this.saveFiles(), action) {
                        case"refreshOrderAjax":
                            result.order.TOTAL.DISCOUNT_PRICE = this.CUSTOM_ECONOMY_VAL;
                            result.order.TOTAL.DISCOUNT_PRICE_FORMATED = this.CUSTOM_ECONOMY_VAL_FORMATED;
            ...
            this.CUSTOM_ECONOMY_VAL = this.result.TOTAL.DISCOUNT_PRICE;
            this.CUSTOM_ECONOMY_VAL_FORMATED = this.result.TOTAL.DISCOUNT_PRICE_FORMATED;
            this.SKIDKA_PERCENT = this.result.TOTAL.TOTAL_SKIDKA;
            this.SKIDKA_PERCENT_FORMATED = this.result.TOTAL.TOTAL_SKIDKA_FORMATED;
        }, initAction: function () {
            ...
            if (this.totalInfoBlockNode && this.result.TOTAL) {
                ...
                if (this.CUSTOM_ECONOMY_VAL) {
                    var skidkaPercent = this.result.TOTAL.TOTAL_SKIDKA_FORMATED;
                }
           ...
           // console.log(params);
           // console.log(params.skidkaPercent);
           // if (params.skidkaPercent) {
           ...
           //          }),
           //              BX.create("SPAN", {
           //                  props: {className: "bx-soa-cart-d percent_skidka"},
           //                  children: params.skidkaPercent
           //              }),
           //              BX.create("SPAN", {
