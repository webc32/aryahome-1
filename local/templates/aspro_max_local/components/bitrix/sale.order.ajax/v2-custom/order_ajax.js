BX.namespace("BX.Sale.OrderAjaxComponent"), function () {
    ...
    BX.Sale && BX.Sale.Input && BX.Sale.Input.Utils && (BX.Sale.Input.Utils.asMultiple = function (value) {
        ...
        initializePrimaryFields: function () {
            ...
            $("[name=ORDER_PROP_54]").val($('input.bx-ui-sls-fake[type=text]').html());
            ...
            while (group = groupIterator())
            {
                ...
                {
                    if (property.getId()=='80' || property.getId()=='81' || property.getId()=='82' || property.getId()=='83' || property.getId()=='84' || property.getId()=='95' || property.getId()=='96' || property.getId()=='99' || property.getId()=='100' || property.getId()=='101') {
