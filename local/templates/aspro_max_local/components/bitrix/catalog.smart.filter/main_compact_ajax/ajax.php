...
<?
if($arResult && class_exists(\Aspro\Max\Smartseo\General\Smartseo::class)) {
    $url = \Aspro\Max\Smartseo\General\Smartseo::getUrlByReal($arResult['FILTER_AJAX_URL'], SITE_ID);
