...
<!--									<div class="basket-checkout-info__value font_xs">-->
<!--                                        {{{DISCOUNT_PRICE_FORMATED}}}-->
<!--                                    </div>-->
<!--								</div>-->
<!--							{{/DISCOUNT_PRICE_FORMATED}}-->
                            ...
                            {{#HAS_RAZNICA}}
                                <div class="basket-checkout-info basket-coupon-total-price-difference custom">

                                    <div class="basket-item-price-difference custom">
                                        {{#TOTAL_SKIDKA}}
                                        <div class="sale-number rounded2">
                                            <div class="value">{{{TOTAL_SKIDKA_FORMATED}}}</div>
                                        </div>
                                        {{/TOTAL_SKIDKA}}
