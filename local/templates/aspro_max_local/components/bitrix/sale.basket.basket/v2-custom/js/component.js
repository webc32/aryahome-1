(function () {
  ...
  BX.Sale.BasketComponent = {
    ...
    init: function (parameters) {
      ...
      if(window.location.search.replace( '?', '') == 'list'){
        this.filter.showFilterByName('not-available');
        this.filter.showNotAvailableItemsFilter();
        this.toggleFilter("not-available");
      }
    },
    ...
    checkMinPrice: function () {
      ...
      if (arAsproOptions["PRICES"]["MIN_PRICE"] && arAsproOptions["PRICES"]["MIN_PRICE"] > this.result.allSum) {
        document.querySelector(".basket-btn-checkout").remove();
