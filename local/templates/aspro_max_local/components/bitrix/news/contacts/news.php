...
<?//$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH.'/js/script_contacts_page.js');?>
<?$APPLICATION->SetAdditionalCss(SITE_TEMPLATE_PATH.'/css/template_contacts_page.min.css');?>


<div class="contacts maxwidth-theme">
	<div class="row fix-mobile-padding mx-md-auto"> <?//wide?>
		<div class="w-100 position-relative mt-4 mb-5">
			<h1 class="title font-weight-800">Наши контакты</h1>
