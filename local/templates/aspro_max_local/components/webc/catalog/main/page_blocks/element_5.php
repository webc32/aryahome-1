<?global $APPLICATION, $arTheme, $bHideLeftBlockByHeader;?>
<?//$APPLICATION->SetPageProperty("HIDE_LEFT_BLOCK", "Y")?>

<?$APPLICATION->SetPageProperty("HIDE_LEFT_BLOCK", (($arTheme["LEFT_BLOCK_CATALOG_DETAIL"]["VALUE"] == "Y" && !$bHideLeftBlockByHeader) ? "N" : "Y"))?>
<?$APPLICATION->AddViewContent('right_block_class', 'catalog_page catalog_page_detail ');?>

<?if($APPLICATION->GetPageProperty("HIDE_LEFT_BLOCK") != "Y" && !$bHideLeftBlockByHeader):?>
	<?$APPLICATION->AddViewContent('right_block_class', ' catalog_page_detail_with_left ');?>
<?else:?>
...
<div class="product-view <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?> main_item_wrapper product-view--mix product-view--mix-wide">
	<?$ElementID = $APPLICATION->IncludeComponent(
		...
		Array(
			...
			"SET_LAST_MODIFIED" => "Y",
			"TITLE_PREVIEW" => ($arParams["TITLE_PREVIEW"] ? $arParams["TITLE_PREVIEW"] : GetMessage("TITLE_PREVIEW")),
			"SHOW_GARANTY" => $arParams["SHOW_GARANTY"],
			"TITLE_GARANTY" => ($arParams["TITLE_GARANTY"] ? $arParams["TITLE_GARANTY"] : GetMessage("TITLE_GARANTY")),
			"SHOW_BUY_DELIVERY" => $arParams["SHOW_BUY_DELIVERY"],
			"TITLE_BUY_DELIVERY" => ($arParams["TITLE_BUY_DELIVERY"]? $arParams["TITLE_BUY_DELIVERY"] : GetMessage("TITLE_BUY_DELIVERY")),
