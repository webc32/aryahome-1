	...
	<div class="stores_block_wrap <?if($bCombineMode):?>combine<?endif;?>">
		...
		<?if($bCombineMode || $bMapMode):?>
			...
			<div class="stores-amount-list<?=($bMapMode ? '  stores-amount-list--active' : '');?>">
				...
				<?else:?>
					<div class="stores_block">
						<div class="stores_text_wrapp"><?=GetMessage("NO_STORES_COORDINATES");?></div>
					</div>
				<?endif;?>
			</div>
		<?endif;?>
	</div>
	<?if($count_stores - $empty_count > 4):?>
	<div class="btn btn-default show_more_stores">Весь список</div>
	<?endif;?>
<?endif;?>