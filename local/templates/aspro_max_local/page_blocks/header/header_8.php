		...
		<div class="wrapp_block">
			<div class="row">
				<div class="items-wrapper flexbox flexbox--row justify-content-between">
					...
					<div class="top-block-item show-fixed top-ctrl top-block-item_custom">
					<?
					global $USER;
					if ($USER->IsAdmin()) {?>
						<div class="version_site">
					...
					<div class="col-md-12">
						<div class="logo-block pull-left floated">
							<div class="logo<?=$logoClass?>">
								<?=CMax::ShowLogo();?>
								<div style="line-height: 25px;position: relative;top: -20px;">
									<a href="https://aryahome.ru/" title="Миграция aryahome" class="version_site_color">Перейти на новую версию сайта</a>
								</div>
							</div>
						</div>
