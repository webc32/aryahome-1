...
if ('Y' == $arParams['SHOW_PARENT_NAME'] && 0 < $arResult['SECTION']['ID'])
{
	...
	?><h1 class="title fix-mobile-padding font-weight-800 d-none d-md-block mt-4 mt-md-0 mb-3" id="<? echo $title_h1; ?>" >

	<?
	if (!empty($arResult['SECTION']['UF_TITLE_H1'])) {
		echo $arResult['SECTION']['UF_TITLE_H1'];
	}else{
		echo (
...
{
?>
<div class="section-list owl-carousel">
	<?
		...
		case 'TILE':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				if (false === $arSection['PICTURE'])
					...
					?>
					<div class="element">
						<a id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" href="<? echo $arSection['SECTION_PAGE_URL']; ?>">
	                        <img src="<? echo $arSection['PICTURE']['SRC']; ?>" loading="lazy" class="w-100" alt="<? echo $arSection['NAME']; ?>">
	                        <div class="name font-weight-500 text-center mt-3"><? echo $arSection['NAME']; ?></div>
	                    </a>
                    </div>
				<?
			}
