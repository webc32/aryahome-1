...
<div class="row wide mx-md-auto">
	...
	?>
	<div class="catalog col-12 mt-md-5">
		<?
		global $USER;
		if ($USER->IsAdmin()):?>
		<?
		$elementId = $APPLICATION->IncludeComponent('bitrix:catalog.element', 'slider-new', $componentElementParams,
			$component
		);
	...
	if ($elementId > 0)
	{
		...
		if (!empty($recommendedData))
		{
			...
			{
				?>
				<div class="catalog similar  fix-mobile-padding w-100 mt-md-5 mt-4">
					<div class="col-12" data-entity="parent-container">
						<div class="row">
	                        <h2 class="title-2 font-weight-800" data-entity="header" data-showed="false"><?=GetMessage('CATALOG_RECOMMENDED_BY_LINK')?></h2>
	                    </div>
						<?
						$APPLICATION->IncludeComponent('bitrix:catalog.recommended.products', '.default', array(
								'ID' => $elementId,
								'IBLOCK_ID' => $arParams['IBLOCK_ID'],
								'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
					...
					<div class="col-12" data-entity="parent-container">
						<div class="row">
							<div class="d-block w-100">
			                    <h2 class="title-2 font-weight-800 mb-4" data-entity="header" data-showed="false"><?=GetMessage('CATALOG_POPULAR_IN_SECTION')?></h2>
								<? $APPLICATION->IncludeComponent('bitrix:catalog.section', '.default', array(
										...
										'BACKGROUND_IMAGE' => '',
										'DISABLE_INIT_JS_IN_COMPONENT' => (isset($arParams['DISABLE_INIT_JS_IN_COMPONENT']) ? $arParams['DISABLE_INIT_JS_IN_COMPONENT'] : ''),
										'CUSTOM_FILTER' => '{\'CLASS_ID\':\'CondIBProp:3:25\',\'DATA\':{\'logic\':\'Equal\',\'value\':5}}]}',
                                        'HIDE_MICRODATA' => 'Y'
									),
									$component
								);
			...
			{
				?>
				<div class="catalog similar fix-mobile-padding w-100 mb-5">
					<div class="col-12" data-entity="parent-container">
						<div class="row">
							<div class="d-block w-100">
			                    <h2 class="title-2 font-weight-800 mb-4" data-entity="header" data-showed="false"><?=GetMessage('CATALOG_VIEWED')?></h2>
