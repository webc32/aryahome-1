...
?>
<div class="catalog w-100" data-entity="<?=$containerName?>">
	<h2 class="big-title text-center font-weight-800 w-100 mt-4 mb-3">Топ товаров</h2>
	<div class="section d-flex flex-wrap w-100">
	<?
		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			...
			switch ($rowData['VARIANT'])
			{
				...
				case 2:
					...
					{
						?>
						<div class="col-sm-3 col-6 product-item-small-card mb-4">
							<?
							$APPLICATION->IncludeComponent(
								'bitrix:catalog.item',
								'.default',
