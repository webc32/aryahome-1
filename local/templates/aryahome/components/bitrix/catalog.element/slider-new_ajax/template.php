		...
		<div class="item element w-100 d-flex flex-wrap" data-id="<?= $arResult["ID"] ?>" data-price="<?= $price['PRICE'] ?>" data-name="<?= $name ?>" data-name-code="<?= $namecode ?>" data-color="<?= $arResult["PROPERTIES"]['TSVET']['VALUE'] ?>" data-preview="<?= $arResult['PREVIEW_PICTURE']['SRC'] ?>" data-size="<?= $RAZMER ?>" data-size-code="<?= $RAZMERCODE ?>">
			...
			<div class="col-12 <? if ($_POST['ajax'] == 'Y') { ?>col-md-9<? } else { ?>col-md-6 mt-md-4<? } ?> order-1 order-md-1">
				<div class="row sliders">
					...
					<?/*if($_POST['ajax'] == 'Y'):?>slider__prev_aj<?else:?>slider__prev<?endif;*/?>

						<div class="slider-control  slider__prev_aj <? if (count($actualItem['MORE_PHOTO']) < 4) : ?>hide<? endif; ?> "><svg fill="#262626" width="17" height="10" viewBox="0 0 17 10" xmlns="http://www.w3.org/2000/svg">
						...
						<div class="slider-control  slider__next_aj <? if (count($actualItem['MORE_PHOTO']) < 4) : ?>hide<? endif; ?>"><svg fill="#262626" width="17" height="10" viewBox="0 0 17 10" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="product-image d-md-block d-none position-relative col">
						...
						<div style="cursor: zoom-in;" class="col2 not-mobil ">
							<span class="product-item-detail-slider-left   slider__prev_aj" data-entity="slider-control-left"></span>
							<div class=" slider__images_aj ">
								<div class="wrap swiper-container">
									<div class="slider swiper-wrapper slider-new  ">
										...
										?>
												<div class="swiper-slide">
													<div class="zoom_aj lider__image " id=" slider-img" data-entity="image" data-id="<?= $photo['ID'] ?>">
														<?/*<a class="zoom1" itemprop="contentUrl" data-fancybox="images" href="<?= $photo['SRC'] ?>">
															<img src="<?= $photo['SRC'] ?>" alt="<?= $alt ?>" title="<?= $title ?>" <?= ($key == 0 ? ' itemprop="image"' : '') ?>>	
														</a>*/?>
														<img src="<?= $photo['SRC'] ?>" alt="<?= $alt ?>" title="<?= $title ?>" <?= ($key == 0 ? ' itemprop="image"' : '') ?>>
													</div>
							...
							<span class="product-item-detail-slider-right  slider__next_aj" data-entity="slider-control-right" style=""></span>
						</div>
					</div>
				</div>
			</div>
