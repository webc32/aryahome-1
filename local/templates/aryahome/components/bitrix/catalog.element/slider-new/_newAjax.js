$(document).ready(function(){
    ...
    $('.zoom').on("mouseover", function(){
        $(".slider__images ").css({"position":"relative", "z-index": "5000"});
    })
    $('.zoom').on("mouseleave", function(){
       $(".slider__images ").css({"position":"relative", "z-index": "0"});
    })
    // $("body").on("click", '.zoomImg', function(){
        
    //     $(this).closest('.lider__image').find('.zoom-fancy').trigger("click");
    // })
