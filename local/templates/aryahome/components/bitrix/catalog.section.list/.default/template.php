...
if ('Y' == $arParams['SHOW_PARENT_NAME'] && 0 < $arResult['SECTION']['ID'])
{
	...
	?><h1 class="title font-weight-800 d-none d-md-block" id="<? echo $this->GetEditAreaId($arResult['SECTION']['ID']); ?>" ><?
	echo (
...
<script src="<?=$this->GetFolder();?>/new.list.js"></script>
<div class="section-list owl-carousel w-100 d-flex justify-content-center py-4">
<?
				...
				if (false === $arSection['PICTURE'])
					...
					<div class="element">
						<a id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" href="<? echo $arSection['SECTION_PAGE_URL']; ?>">
	                        <img src="<? echo $arSection['PICTURE']['SRC']; ?>" loading="lazy" class="w-100">
