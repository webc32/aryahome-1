...
class Store extends Market\Trading\Entity\Reference\Store
{
	...
	public function getAmounts($stores, $productIds)
	{
		...
		{
			$result = $this->applyQuantityLimitByProduct($result);
		}
	...
	protected function applyQuantityLimitByProduct(array $amounts)
	{
		$productIds = array_column($amounts, 'ID');
		$limits = $this->loadQuantityLimitFromProduct($productIds);
	...
	protected function loadQuantityLimitFromProduct(array $productIds)
	{
		$result = [];
