...
$MESS['YANDEX_MARKET_TRADING_ENTITY_SALE_ENTITY_ORDER_BASKET_ITEM_SHIPMENT_MISSING'] = 'Отсутствует отгрузка для доставки товара';
$MESS['YANDEX_MARKET_TRADING_ENTITY_SALE_ENTITY_ORDER_BASKET_ITEM_SHIPMENT_ITEM_MISSING'] = 'Не удалось добавить товар в отгрузку';
